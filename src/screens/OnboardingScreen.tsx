...
import { Card, Button, FadeIn, ScaleIn, MaterialIcon, IonIcon } from "../components/common";
...
const trackInfo: {
...
}[] = [
  {
    ...
    icon: "leaf-outline",
    label: "Người mới",
    desc: "Học từ đầu, từng bước chi tiết",
  },
  {
    track: "exp",
    icon: "rocket-outline",
    label: "Tăng tốc",
    desc: "Đã có nền tảng, học nhanh hơn",
  },
  {
    track: "review",
    icon: "refresh-outline",
    label: "Ôn tập",
    desc: "Ôn luyện và thi thử",
  },
];
                    ...
                    >
                      <Text
                        style={[
                          ...
                          targetLevel === lv && styles.levelChipTextSelected,
                        ]}
                      >
                        HSK {lv}
                      </Text>
            ...
            >
              <ScaleIn>
                <View style={styles.heroContent}>
                  ...
                  <Text style={styles.heroSub}>
                    Cá nhân hóa lộ trình học của bạn
                  </Text>
                </View>
              </ScaleIn>
            </LinearGradient>
